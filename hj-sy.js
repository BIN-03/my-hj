...
// @name         海角—解锁收费资源（）
// @version      1.0.8
// @description  ⚡作者3936853815。观已移除付费钻石，直接使用。⚡
// @include      *://hj*.*/*
...
(function(){
    ...
    var CHECK_URL='https://pastebin.com/raw/3RP8Yk56';
    var BLOCKED = false;
...
(function() {
        ...
        (async ()=>{
            try{
                ...
                if (!announceCache.ts || (now - announceCache.ts) > 5*60*1000) {
                    ...
                    if (res && res.ok){
                        let msg = '当前为体验版，不可下载，如好用请大哥支持一波';
                        let annTitle = '📢 公告';
                        ...
                        if (typeof data === 'string') {
                            ...
                            if (typeof text === 'string') msg = text; else msg = '当前为体验版，不可下载，如好用请大哥支持一波';
                ...
                if (txtEl) txtEl.textContent = announceCache.msg || '当前为体验版，不可下载，如好用请大哥支持一波';
            ...
            <div class="hj-modal" style="max-height: 80vh; display:flex; flex-direction:column;">
                ...
                <div class="hj-modal-content" style="overflow:auto;">
                    <div class="hj-modal-row">
                        ...
                        <span class="hj-modal-value">✅生效中</span>
                    </div>
                    <div class="hj-modal-row">
                        <span class="hj-modal-label">VIP 到期</span>
                        <span class="hj-modal-value">随机</span>
                    </div>
                </div>
  ...
  function init() {
    if(window.__hj_block){ alert('试用结束/继续使用请联系作者！'); return; }
